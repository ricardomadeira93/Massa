...
export const deliverySlots: DeliverySlot[] = [
  ...
  },
  {
    ...
    dateLabel: {
      ...
      it: 'Sab — 14:00 alle 17:00',
      ar: 'السبت — 2:00 م إلى 5:00 م',
    },
    remaining: 2,
    total: 3,
  },
  {
    ...
    dateLabel: {
      ...
      es: 'Dom. — 9:00 a 12:00',
      it: 'Dom — 9:00 alle 12:00',
      ar: 'الأحد — 9:00 ص إلى 12:00 م',
    },
    remaining: 4,
    total: 5,
  },
  {
    ...
    dateLabel: {
      ...
      it: 'Dom — 14:00 alle 17:00',
      ar: 'الأحد — 2:00 م إلى 5:00 م',
    },
    remaining: 5,
    total: 5,
  },
